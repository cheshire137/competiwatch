...
ActiveRecord::Schema.define(version: 20180310234150) do
  ...
  create_table "account_heroes", force: :cascade do |t|
    ...
    t.index ["account_id", "hero_id"], name: "index_account_heroes_on_account_id_and_hero_id", unique: true
    t.index ["account_id", "seconds_played"], name: "index_account_heroes_on_account_id_and_seconds_played"
    t.index ["hero_id"], name: "index_account_heroes_on_hero_id"
  end
